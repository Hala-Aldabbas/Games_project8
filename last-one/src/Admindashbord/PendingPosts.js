...
<button  type="submit" className="btn btn-success mx-1"><a onClick={() => editConfirm(post.id,1)} className="button-44"> Approve </a>
</button>
  <button  type="button" className="btn btn-danger mx-1">Reject</button>

{/* <form className=' container' onSubmit={handleSubmit} >
  
<select className="form-select" name='Approve' aria-label="Default select example" onChange={handleChange}>
